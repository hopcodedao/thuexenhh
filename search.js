...
const inputForm = document.querySelectorAll('.form__group input');

const modalMore = document.querySelector('.modal__more');
const openSH = document.querySelector('.open__sh');
const modalSH = document.querySelector('.modal__sh');
const closeSH = document.querySelector('.close__sh');
const openH2 = document.querySelector('.open__h2');
const modalH2 = document.querySelector('.modal__h2');
const closeH2 = document.querySelector('.close__h2');
const openZ1000 = document.querySelector('.open__z1000');
const modalZ1000 = document.querySelector('.modal__z1000');
const closeZ1000 = document.querySelector('.close__z1000');
...
//1 xe
function toggleModalSH() {
    modalSH.classList.toggle('hide')
}
...
modalSH.addEventListener('click', function(e) {
    if(e.target == e.currentTarget){
        toggleModalSH()
    }
})

closeSH.addEventListener('click', toggleModalSH)

//1 xe
function toggleModalH2() {
    modalH2.classList.toggle('hide')
}
...
modalH2.addEventListener('click', function(e) {
    if(e.target == e.currentTarget){
        toggleModalH2()
    }
})

closeH2.addEventListener('click', toggleModalH2)

//1 xe
function toggleModalZ1000() {
    modalZ1000.classList.toggle('hide')
}
...
modalZ1000.addEventListener('click', function(e) {
    if(e.target == e.currentTarget){
        toggleModalZ1000()
    }
})

closeZ1000.addEventListener('click', toggleModalZ1000)
